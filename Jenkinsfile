		...
		stage('GitHub Release') {
			steps {
				bat multiline([
					...
					"echo Create Release",
					"github-release\\github-release.exe release --user littork --repo \"CEC-CSC160-Final-Project\" --tag \"Build #${BUILD_NUMBER}\" --name \"Production Release\" --description \"CEC final project automated release for ${BRANCH_NAME} branch\"",
