				...
				stage('Build Debug x64') {
					steps {
						...
						bat multiline([
							...
							"set _CL_=/MTd",
							"Msbuild.exe ./curl/built/lib/libcurl.vcxproj /p:Configuration=Debug /p:SolutionDir=../../../\" \"/property:DefineConstants=USE_SSLEAY%3BUSE_OPENSSL\""
						])
				...
				stage('Build Release x64') {
					steps {
						...
						bat multiline([
							"\"C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Community\\VC\\Auxiliary\\Build\\vcvarsall.bat\" x86_x64",
							"set _CL_=/MT",
							"Msbuild.exe ./curl/built/lib/libcurl.vcxproj /p:Configuration=Release /p:SolutionDir=../../../ \"/property:DefineConstants=USE_SSLEAY%3BUSE_OPENSSL\""
						])
